...
class Producto(db.Model):  # Producto hereda de db.Model
    ...
    talle = db.Column(db.String(100))
    imagen = db.Column(db.String(400))

    def __init__(self, nombre, precio, stock,talle,  imagen):
        """
...
class ProductoSchema(ma.Schema):
    ...
    """
    class Meta:
        fields = ("id", "nombre", "precio", "stock","talle", "imagen")
...
def create_producto():
    ...
    new_producto = Producto(nombre, precio, stock,talle, imagen)  # Crea un nuevo objeto Producto con los datos proporcionados
